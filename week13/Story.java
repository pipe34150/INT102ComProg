...
public class Story {
    ...
    public boolean isMatch(Story s) {
        if (s.storyName != null && s.storyName.equals(this.storyName)) {
            return true;
        } else if (s.writtenDate != null && s.writtenDate.equals(this.writtenDate)) {
            return true;
        } else if (s.content != null && s.content.equals(this.content)) {
            return true;
        } else {
            return false;
        }
